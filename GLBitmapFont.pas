...
// ------------------------------------------------------------------
// ------------------------------------------------------------------
procedure TGLCustomBitmapFont.LoadFromPngTexture(FileName: String);
begin
  FUsePng:= True;
  FPngObject:= TPngObject.Create;
  FPngObject.LoadFromFile(FileName);
  FPngObject.CreateAlpha;
  Self.Glyphs.LoadFromFile(FileName);
end;
